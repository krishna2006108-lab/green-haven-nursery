...
import { BUSINESS_INFO, NAV_LINKS, getWhatsAppLink } from "@/lib/constants";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Premium quality nursery plants direct from our farm in {BUSINESS_INFO.city}. 
              Serving customers across India with the finest outdoor, fruit, and flowering plants.
            </p>
          </div>
